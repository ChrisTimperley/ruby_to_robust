...
class TestIntegerDivision < Test::Unit::TestCase
  ...
  def test_standard_behaviour
    ...
    assert_equal(5, RubyToRobust::Local.protected { program[50, 10] })
  ...
  def test_soft_dbz
    program = lambda { |x, y| x / y }
    assert_equal(0, RubyToRobust::Local.protected { program[1, 0] })
    assert_equal(0, RubyToRobust::Local.protected { program[2, 0] })
    assert_equal(0, RubyToRobust::Local.protected { program[10, 0] })
    assert_equal(0, RubyToRobust::Local.protected { program[255, 0] })
  end
